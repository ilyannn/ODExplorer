...
{
    [self.library.nominalTypes enumerateKeysAndObjectsUsingBlock:^(id key, ODNominalType *obj, BOOL *stop) {
...
{
    NSArray *north = [[self.library.nominalTypes allValues] arrayByFiltering:^BOOL(ODNominalType *type) {
